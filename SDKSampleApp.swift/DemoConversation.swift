...
let AvatarLeonard = JSQMessagesAvatarImageFactory.avatarImage(with: UIImage(named:"goldengate")!, diameter: 12)

let AvatarCook = JSQMessagesAvatarImageFactory.avatarImage(with: UIImage(named:"demo_avatar_cook")!, diameter: 12)

// Create avatar with Placeholder Image
let AvatarJobs = JSQMessagesAvatarImageFactory.avatarImage(with: UIImage(named:"demo_avatar_jobs")!, diameter: 12)
let AvatarWoz = JSQMessagesAvatarImageFactory.avatarImage(with: UIImage(named:"demo_avatar_woz")!, diameter: 12)
let AvatarSquires = JSQMessagesAvatarImageFactory.avatarImage(with: UIImage(named:"goldengate")!, diameter: 12)
//
